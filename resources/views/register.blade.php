    ...
    <div style="height:150px">
        <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top" style="height:90px">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a href="{{url('/user/login')}}"><button class="btn" type="submit">Login</button></a>
    ...
    <div style="background-color:white;" class="d-flex justify-content-center mb-5">
        ...
        <form method="POST" action="{{url('/otp/login')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="otp" name="otp" value="{{ old('otp') }}" placeholder="Enter OTP">
            </div>
